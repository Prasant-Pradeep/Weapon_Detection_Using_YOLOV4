...
public class Custimage2 extends ArrayAdapter<String>  {
	...
	private String[] certificate;
	 ...
	 public Custimage2(Activity context, String[] cid ) {
	        //constructor of this class to get the values from main_activity_class

	        super(context, R.layout.cust_images2, cid);
	        this.context = context;

		    this.certificate = cid;
...
//			t2.setText(caption[position]);
	       ...
	       String pth = "http://"+sh.getString("ip", "")+"/"+certificate[position];
	       pth = pth.replace("~", "");
