...
public class Video_upload extends AppCompatActivity implements JsonResponse {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        url = "http://"+Ipsettings.text+"/api/upload_video";
...
//	        	rid=View_waste_disposal_request.report_id;
            ...
            String q = "http://" +Ipsettings.text+"/api/upload_video";
...
//	        	String q= "api.php?action=teacher_upload_notes&sh_id="+Teacher_view_timetable.s_id+"&desc="+des;
            ...
            fua.json_response = (JsonResponse) Video_upload.this;
            fua.execute(aa);
        } catch (Exception e) {
...
//		                pre = ja.getJSONObject(0).getString("precatuions");
                    ...
                    startActivity(new Intent(getApplicationContext(), Video_upload.class));
