...
public class ImageView extends AppCompatActivity implements JsonResponse {
    ListView l1;
...
//        l1.setOnItemClickListener(this);
        ...
        JR.json_response = (JsonResponse) ImageView.this;
        String q = "/imgses?log_id=" +sh.getString("log_id", "")+"&rid="+Viewrequest.rid;
        q = q.replace(" ", "%20");
        JR.execute(q);
    }
